...
public struct UpdateSignalRequest: Codable {
    ...
    public init(channel: Int? = nil, conversion: SignalConversion? = nil, dataId: String? = nil, dataType: Int? = nil, description: String? = nil, display: SignalDisplay? = nil, label: String? = nil) {
