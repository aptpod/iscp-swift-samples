...
public struct EdgeConnectionItem: Codable {
    ...
    public init(uuid: String, lastLivedAt: String, edge: EdgeConnectionEdge?, createdAt: String, updatedAt: String) {
        self.uuid = uuid
