//
// MeasurementMarkerPutRequestPoint.swift
//
...
public struct MeasurementMarkerPutRequestPoint: Codable {
    ...
    public init(name: String? = nil, description: String? = nil, type: ModelType? = nil, tag: AnyCodable? = nil, detail: MeasurementMarkerDetailPoint? = nil) {
        self.name = name
