...
public struct Measurement: Codable {
    ...
    public var sequences: MeasurementSequencesSummary
    public var markers: [MeasurementMarker]?
    /** 計測の作成日時 */
    ...
    public init(uuid: String, name: String, description: String, basetime: String, basetimeType: MeasurementBaseTimeType, edgeUuid: String, duration: Int64, maxElapsedTime: Int64? = nil, completed: Bool? = nil, protected: Bool, sequences: MeasurementSequencesSummary, markers: [MeasurementMarker]? = nil, createdAt: Date, updatedAt: Date, processedRatio: Double, ended: Bool, status: Status) {
        self.uuid = uuid
        self.name = name
